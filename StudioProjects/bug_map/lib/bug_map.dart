    ...
    FloatingActionButton(
      ...
      onPressed: () {
        GoogleMap.of(_key).addMarkerRaw(
          const GeoCoord(33.875513, -117.550257),
          info: 'test info',
      ...
      children: <Widget>[
        Positioned.fill(
          child: GoogleMap(
            ...
            initialZoom: 12,
            initialPosition:
            const GeoCoord(34.0469058, -118.3503948), // Los Angeles, CA
          ...
          child: FloatingActionButton(
            ...
            onPressed: () {
              final bounds = GeoCoordBounds(
                northeast: const GeoCoord(34.021307, -117.432317),
                southwest: const GeoCoord(33.835745, -117.712785),
              );
