...
class _StudentLoginState extends State<StudentLogin> {
  ...
  Widget build(BuildContext context) {
    return Form(
        //return form for formKey.
        key: _formKey,
        child: Padding(
            //we cant use two times scaffold in a single widget.
                ...
                ElevatedButton(
                    onPressed: () {
                      ...
                      if (_formKey.currentState!.validate()) {
                        //currentState! means currentState should not be null
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => studentData(
                                  idValue: _idController.text
                                      .toUpperCase()), //it will take input argument idController as input
                            )).then((value) {
                          _idController.clear();
